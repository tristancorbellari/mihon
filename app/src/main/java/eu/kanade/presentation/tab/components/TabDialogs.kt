...
fun TabCreateDialog(
    ...
    val nameAlreadyExists = remember(name) { tabs.contains(name) }
...
fun TabRenameDialog(
    ...
    var name by remember { mutableStateOf(tab) }
...
fun TabDeleteDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text(text = stringResource(MR.strings.delete_category_confirmation, tab))
        },
    )
}
...
@Composable
fun ChangeTabDialog(
    initialSelection: ImmutableList<CheckboxState<Tab>>,
    onDismissRequest: () -> Unit,
    onEditTabs: () -> Unit,
        ...
        text = {
            Column(
                ...
                selection.forEach { checkbox ->
                    val onChange: (CheckboxState<Tab>) -> Unit = {
